      ...
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <p className="text-2xl sm:text-[20px] my-auto ms-[12px] font-semibold">
              Muhammad Isa
            </p>
          </Link>
        </div>
        ...
        <div className="lg:flex items-center">
          ...
          <p className="">
            <Link
              className="btn btn-sm xs:btn-md sm:btn-lg btn-primary text-12px xxs:text-[14px] sm:text-[16px] text-white ms-4"
              href="#contact"
              to={`contact`}
              smooth={true}
              duration={900}
